					        ...
					        <tr>
					           	...
					           	<td>
					           		<ul>
					           			...
					           			<li>
					           				<a href="delete_document.php?id_catatan=<?php echo $data['id_catatan'];?>" onclick="return confirm('Yakin mau di hapus?');" class="glyphicon glyphicon-trash"></a>
					           			</li>
