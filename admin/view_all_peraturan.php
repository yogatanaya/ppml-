					        ...
					        <tr>
					           	...
					           	<td>
					           		<ul>
					           			...
					           			<li>
					           				<a href="delete_document.php?id_peraturan=<?php echo $data['id_peraturan'];?>" onclick="return confirm('Yakin mau di hapus?');" class="glyphicon glyphicon-trash"></a>
					           			</li>
